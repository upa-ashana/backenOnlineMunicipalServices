...
import edu.usha.bim.sumProj2018.onlineSerRegPayment.dto.LoginDto;
...
public class LoginController {
    ...
    public JwtToken login(@RequestBody LoginDto userJsonObj) throws ServletException {
...
//        UserLogin userInDb = loginrepo.findByUserNameAndPassword(username, passwordEncoder.encode(password));
        ...
        token.setUserId(userInDb.getUserId());
        return token;
    }
}
